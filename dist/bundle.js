...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_scoreHandlers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/scoreHandlers.js */ \"./src/modules/scoreHandlers.js\");\n\n\n\nconst form = document.getElementById('score-form');\nconst refreshButton = document.getElementById('refresh');\n\nform.addEventListener('submit', async (event) => {\n  event.preventDefault();\n  const name = document.getElementById('name').value;\n  const score = document.getElementById('score').value;\n  await (0,_modules_scoreHandlers_js__WEBPACK_IMPORTED_MODULE_1__.addScore)(name, score); // Add the score using the async function\n  form.reset(); // Reset the form fields\n});\n\nrefreshButton.addEventListener('click', async () => {\n  await (0,_modules_scoreHandlers_js__WEBPACK_IMPORTED_MODULE_1__.refreshScores)(); // Refresh scores using the async function\n});\n\n//# sourceURL=webpack:///./src/index.js?");
